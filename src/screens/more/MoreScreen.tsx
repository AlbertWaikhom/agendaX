    ...
    <PageContainer>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.menuGroup}>
          ...
          >
            <View style={styles.menuItemLeft}>
              ...
              <View>
                <Text style={styles.menuTitle}>About Planora (AgendaX)</Text>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerAppTitle}>PLANORA</Text>
          <Text style={styles.footerTagline}>Plan. Track. Achieve.</Text>
          <Text style={styles.footerVersion}>v1.0.0 • 100% Offline Local Engine</Text>
        </View>
      </ScrollView>
